...
export const ABOUT_IMAGERY = {
  ...
  bancoLavoro: {
    src: `${dir}/banco-lavoro.jpg`,
    pexels: 6790031,
    alt: "altBanco",
    tone: { brightness: 0.88, contrast: 1.07 },
  },
  sicurezza: {
    src: `${dir}/sicurezza.jpg`,
    pexels: 8488037,
    alt: "altSicurezza",
    tone: { brightness: 0.95, contrast: 1 },
  },
  lavorazioneLegno: {
    src: `${dir}/lavorazione-legno.jpg`,
    pexels: 5711774,
    alt: "altLavorazione",
    tone: { brightness: 1.15, contrast: 1 },
  },
  progettoTavolo: {
    src: `${dir}/progetto-tavolo.jpg`,
    pexels: 4792480,
  ...
  utensili: { src: `${dir}/utensili.jpg`, pexels: 5974028, alt: "" },

  // Territory block: 3:2 beside a 4:5.
  porticiModena: {
    src: `${dir}/portici-modena.jpg`,
    pexels: 36739215,
    alt: "altPortici",
  },
  ghirlandina: {
    src: `${dir}/ghirlandina.jpg`,
    pexels: 36494223,
    alt: "altGhirlandina",
  },
  ...
  cantiereInterno: {
    src: `${dir}/cantiere-interno.jpg`,
    pexels: 36035072,
    alt: "altCantiere",
  },
  posaMattoni: {
    src: `${dir}/posa-mattoni.jpg`,
    pexels: 19688828,
    alt: "altPosaMattoni",
  },
  ponteggio: {
    src: `${dir}/ponteggio.jpg`,
    pexels: 5820968,
    alt: "altPonteggio",
  },
  facciataStorica: {
    src: `${dir}/facciata-storica.jpg`,
    pexels: 9784173,
    alt: "altFacciata",
  },
  mansarda: { src: `${dir}/mansarda.jpg`, pexels: 8082327, alt: "altMansarda" },
  consegna: { src: `${dir}/consegna.jpg`, pexels: 7031621, alt: "altConsegna" },

  /** Certifications panel, 3:2. */
  documenti: {
    src: `${dir}/documenti.jpg`,
    pexels: 8470801,
    alt: "altDocumenti",
  },
