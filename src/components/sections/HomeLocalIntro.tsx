...
export async function HomeLocalIntro() {
  ...
  return (
    <section
      className="relative overflow-hidden border-b border-white/[0.06] bg-surface-base px-4 py-24 sm:px-6"
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.35fr)] lg:gap-16">
        <FadeIn>
          ...
          <h2
            ...
            className="mt-3 text-balance font-serif text-3xl text-white sm:text-4xl"
          >
            {t("title")}
          </h2>
        </FadeIn>
