        ...
        >
          {items.map((it) => (
            <motion.li
              key={it.title}
              variants={itemVar}
              className="group relative overflow-hidden rounded-2xl border border-line bg-raised p-6 transition hover:border-accent/40 hover:bg-raised-2"
            >
              <span
                aria-hidden="true"
              ...
              />
              <div className="mb-4 inline-flex rounded-xl bg-accent/15 p-3 text-accent-ink transition group-hover:scale-105">
